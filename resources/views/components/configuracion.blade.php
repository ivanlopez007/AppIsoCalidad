            ...
            <aside class="w-full md:w-64 bg-gray-50/50 dark:bg-gray-900/20 border-r border-gray-100 dark:border-gray-700 p-6">
                <nav class="space-y-2">
                    <a href="#" class="flex items-center px-4 py-3 bg-white dark:bg-gray-800 text-primary shadow-sm rounded-2xl font-bold transition-all">
                        <span class="material-symbols-rounded mr-3 text-xl">person</span> Perfil
                    </a>
                    <a href="#" class="flex items-center px-4 py-3 text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-gray-800 rounded-2xl transition-all">
                        <span class="material-symbols-rounded mr-3 text-xl">lock</span> Seguridad
                    </a>
                    <a href="#" class="flex items-center px-4 py-3 text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-gray-800 rounded-2xl transition-all">
                        <span class="material-symbols-rounded mr-3 text-xl">notifications</span> Notificaciones
                    </a>
                    <a href="#" class="flex items-center px-4 py-3 text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-gray-800 rounded-2xl transition-all">
                        <span class="material-symbols-rounded mr-3 text-xl">credit_card</span> Suscripción
                    </a>
                </nav>
            </aside>
                    ...
                    <section class="mb-10">
                        ...
                        <div class="flex items-center gap-6 mb-8">
                            <div class="relative group/avatar">
                                <input type="file" id="inputAvatar" name="avatar" accept="image/*" class="hidden">

                                <div onclick="document.getElementById('inputAvatar').click()" class="cursor-pointer relative overflow-hidden rounded-3xl h-24 w-24 ring-4 ring-gray-50 dark:ring-gray-700 bg-gray-100 dark:bg-gray-700">
                                    <img id="vistaPreviaAvatar" src="https://ui-avatars.com/api/?name=Ivan+Lopez&background=6366f1&color=fff" class="h-full w-full object-cover transition-transform group-hover/avatar:scale-105" alt="Avatar">
                                    <div class="absolute inset-0 bg-black/10 opacity-0 group-hover/avatar:opacity-100 transition-opacity flex items-center justify-center"></div>
                                </div>

                                <button type="button" onclick="document.getElementById('inputAvatar').click()" class="absolute -bottom-2 -right-2 bg-white dark:bg-gray-700 p-2.5 rounded-xl shadow-lg border border-gray-100 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary transition-colors flex items-center justify-center">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        inputAvatar.addEventListener("change", function() {
            ...
            vistaPreviaAvatar.src = objectURL;
        });
    });
</script>
